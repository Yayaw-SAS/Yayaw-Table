  ...
  if (compact) {
    return (
      <Drawer onOpenChange={onOpenChange} open={open} repositionInputs={false}>
        <DrawerContent
          className="max-h-[92dvh] overflow-clip pb-[env(safe-area-inset-bottom)] data-[vaul-drawer-direction=bottom]:max-h-[92dvh] [&_[data-slot=select-trigger]]:min-h-11 [&_button]:min-h-11"
