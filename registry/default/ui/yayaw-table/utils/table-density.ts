...
export const TABLE_DENSITY_CLASSES = {
  ...
  large: {
    ...
    controls:
      "[--yayaw-inline-control-height:2.0rem] [&_[data-density-control]]:!min-h-8 [&_[data-density-control]]:!py-0 [&_[data-density-action]]:!h-8 [&_[data-density-action]]:!w-8 [&_td_img]:!max-h-8 [&_td_img]:!max-w-8",
  },
  "extra-large": {
    rows: "[&_tr]:h-14",
    header: "!h-14 !px-3",
  ...
  "extra-extra-large": {
    ...
    controls:
      "[--yayaw-inline-control-height:2.5rem] [&_[data-density-control]]:!min-h-10 [&_[data-density-control]]:!py-0 [&_[data-density-action]]:!h-10 [&_[data-density-action]]:!w-10 [&_td_img]:!max-h-10 [&_td_img]:!max-w-10",
  },
