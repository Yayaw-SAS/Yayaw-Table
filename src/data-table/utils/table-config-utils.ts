...
export const tableConfigUtils = {
     ...
     */
    fromStorage: (serializedConfig: SerializedTableViewConfig | string): TableViewConfig => {
        ...
        return {
            ...
            columnVisibility: safelyParse<ColumnVisibilityState>(config.columnVisibility, {}),
    ...
    toStorage: (config: TableViewConfig): SerializedTableViewConfig => {
        ...
        return {
            columnFilters: normalizedColumnFilters
                ...
                : undefined,
            columnOrder: config.columnOrder ? JSON.stringify(config.columnOrder) : undefined,
