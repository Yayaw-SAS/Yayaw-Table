...
export function FilterEmptyState({
    ...
    return (
        <div className={cn('py-8 text-center', className)}>
            ...
            <p className="mx-auto mb-6 max-w-md text-muted-foreground text-sm">{description}</p>
...
export function FilterNoResultsState({
    ...
    return (
        <div className={cn('py-8 text-center', className)}>
            ...
            {/* Content */}
            <h3 className="mb-2 font-medium text-foreground text-lg">No results found</h3>
...
export function FilterPerformanceIndicator({
    ...
    const displayTime = filterTime < 1000 ? `${filterTime}ms` : `${(filterTime / 1000).toFixed(1)}s`
