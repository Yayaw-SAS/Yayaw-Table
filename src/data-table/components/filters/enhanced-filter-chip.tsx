...
import { Calendar, CheckSquare, ChevronDown, Filter, Hash, List, Type, X, Zap } from 'lucide-react'
...
function formatFilterValue(
    ...
    return displayValue.length > maxLength ? `${displayValue.slice(0, maxLength)}...` : displayValue
}

/**
 * Get operator display text
 */
function getOperatorText(operator: FilterOperators[ColumnDataType], _type: ColumnDataType): string {
