...
export function MultiOptionFilter({
    ...
    const displayedTags = useMemo(() => {
        ...
        return { tags, hasMore, remainingCount: internalValue.length - maxDisplayedTags }
        ...
        <div className="space-y-3">
            ...
            <div className="flex flex-col gap-3">
                ...
                {showOperator && (
                    <Select
                        value={operator}
                        onValueChange={(value) => onOperatorChange(value as FilterOperators['multiOption'])}
                        disabled={disabled}
                    >
                                                ...
                                                <>
                                                    ...
                                                    {internalValue.length > 0 && (
                                                        <CommandItem
                                                            ...
                                                            className="justify-center border-b mb-1"
                                                        >
                                                            Clear All
                                                        </CommandItem>
                                                    )}
...
export function CompactMultiOptionFilter({
    ...
    placeholder = "Select...",
    maxDisplayedTags = 2
}: Pick<MultiOptionFilterProps, 'value' | 'operator' | 'options' | 'onValueChange' | 'disabled' | 'placeholder' | 'maxDisplayedTags'>) {
    const [internalValue, setInternalValue] = useState(value)
    const [isOpen, setIsOpen] = useState(false)
