...
interface TableActions {
  create?: (data: Record<string, unknown>) => Promise<{ success: boolean; data?: unknown; error?: string }>
  update?: (id: string, data: Record<string, unknown>) => Promise<{ success: boolean; data?: unknown; error?: string }>
  delete?: (id: string) => Promise<{ success: boolean; data?: unknown; error?: string }>
  ...
  duplicate?: (id: string) => Promise<{ success: boolean; data?: unknown; error?: string }>
  [key: string]: unknown
}
...
interface TableProviderContextType {
  ...
  getFormConfig?: <TFieldValues extends FieldValues = FieldValues>(formType: string) => FormConfig<TFieldValues> | undefined
  ...
  TitleComponent?: React.ComponentType<{ children: React.ReactNode; className?: string }>
  DescriptionComponent?: React.ComponentType<{ children: React.ReactNode; className?: string }>
}

const TableProviderContext = createContext<TableProviderContextType | undefined>(undefined)
