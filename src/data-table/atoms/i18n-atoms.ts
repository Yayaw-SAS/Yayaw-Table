 ...
 */
export const translationsAtom = atom<Partial<Record<keyof DataTableTranslations, string>>>({})
 ...
 */
export const tableTranslationOverridesAtom = atomFamily((tableId: string) =>
 ...
 */
export const dataTableTranslationKeysAtom = atom<DataTableTranslations>(translationKeysMap)

/**
 * Atom for resolved translations
 * Components use this atom directly, without knowing how translations are resolved
 */
export const resolvedTranslationsAtom = atom<DataTableTranslations>({} as DataTableTranslations)
