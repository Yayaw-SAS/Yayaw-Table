...
const StackMenuContent = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
    ({ className, ...props }, ref) => <div className={cn('p-3', className)} ref={ref} {...props} />
)
...
interface StackMenuItemProps extends React.ButtonHTMLAttributes<HTMLButtonElement> {
    ...
    (
        ...
        return (
            ...
            >
                ...
                {endIcon && <div className="flex-shrink-0 text-muted-foreground">{endIcon}</div>}
            </Button>
        )
    }
)
...
// Separator component
const StackMenuSeparator = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
    ({ className, ...props }, ref) => (
