...
export function getLucideIcon(iconName: string): null | React.FC<LucideProps> {
    return (LucideIcons as unknown as Record<string, React.FC<LucideProps>>)[iconName] || null
}
