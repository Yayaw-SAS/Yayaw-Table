...
describe("resolveTranslationsToUiStrings", () => {
  it("resolves every footer calculation key from DataTableTranslations", () => {
    ...
    assert.equal(resolved.calcPercent, defaultTranslations.calculations.percent);
    assert.equal(resolved.calcMore, defaultTranslations.calculations.more);
    assert.equal(resolved.calcCountAll, defaultTranslations.calculations.count_all);
    assert.equal(
    ...
    assert.equal(resolved.calcAverage, defaultTranslations.calculations.average);
