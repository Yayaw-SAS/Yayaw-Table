...
import { localDayKey, loadScopedRows } from "@/src/components/ui/yayaw-table/utils/scoped-rows";
...
const THEME_STYLE = {
  ...
  "--fc-classic-highlight": "color-mix(in oklab, var(--primary) 12%, transparent)",
  ...
  return (
    <div className="flex flex-wrap items-center justify-between gap-2">
      <div className="flex items-center gap-1">
        ...
        <h3 className="ml-2 font-medium text-base capitalize" data-calendar-title>
          {title}
        </h3>
      </div>
