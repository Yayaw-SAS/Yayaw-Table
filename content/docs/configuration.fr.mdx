...
Autorise la sélection de plusieurs lignes. Quand cette option est activée, cliquez sur la checkbox d'une ligne sélectionnable, puis faites Maj+clic sur une autre pour sélectionner ou désélectionner la plage inclusive dans l'ordre courant. Les lignes non sélectionnables sont ignorées.
