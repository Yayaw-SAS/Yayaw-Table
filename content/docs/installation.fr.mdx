---
title: Installation
description: Installer YaYaw Table via la registry Shadcn
---

# Installation

YaYaw Table est distribué via une **registry Shadcn**. La CLI copie le code complet dans votre projet, vous gardez donc un ownership local total.
