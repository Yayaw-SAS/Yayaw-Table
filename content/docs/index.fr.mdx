...
const columns = [
  ...
  { id: "metadata", type: "json", header: "Métadonnées" },
...
- [Formulaires et champs collection](/docs/forms) – Champs de formulaire, éditeurs de tableaux natifs, collections imbriquées et validation
...
- [URL state (Nuqs)](/docs/url-state) – Tri, filtres, modes d'affichage, vues enregistrées et pagination dans l'URL
