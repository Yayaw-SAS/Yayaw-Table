...
YaYaw Table normalise encore les retours legacy des callbacks, mais le contrat explicite par objet est fortement recommandé pour un comportement prévisible.
