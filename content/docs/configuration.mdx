...
Allow selecting multiple rows. When enabled, click a selectable row checkbox and then Shift-click another to select or deselect the inclusive range in the current row order. Rows that cannot be selected are skipped.
