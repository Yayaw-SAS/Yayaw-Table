---
title: Forms, Sections, and Collection Fields
description: Build create/edit forms with grouped fields, native array editors, validation, and nested collection support
---

# Forms, Sections, and Collection Fields
...
Fields not referenced by any section still render after the declared sections, preserving the original field order. Unknown field names are ignored, which keeps generated configuration tolerant while still rendering every known field.
