...
- Top-level table behavior keys like `layoutPreset`, `emptyState`, `rowClickMode`, `enableRowSelection`, `enableRowClickEdit`, `enableSorting`, `enableColumnFilters`, `defaultPageSize`, `pageSizeOptions`, `export`, `bulkExport`, `actionsAsIcons`.
