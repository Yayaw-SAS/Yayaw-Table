                ...
                <div className="mx-auto max-w-4xl px-6 text-center">
                    ...
                    <div className="space-y-6">
                        ...
                        <p className="mx-auto max-w-2xl text-muted-foreground text-xl">
                            A flexible, powerful data table component library for React that lets
                            you
...
/>`}
                    ...
                    <div className="mt-8 rounded-lg border border-border bg-accent/50 p-4">
                        <p className="text-muted-foreground text-sm">
                            🎨 <strong className="text-foreground">Try the theme toggle</strong> in
                            the top-right corner to see how YaYaw Table adapts to your design
                            system!
                        </p>
                    </div>
                </div>
